...
export const HELP_TEXT = [
  ...
  '• Kategori: "kategori" (lihat) atau "kategori tambah Zakat" (tambah baru)',
  ...
  '',
  'Ketik "panduan" untuk dokumentasi lengkap.',
].join('\n');

// Full documentation, shown by the "panduan" / "dokumentasi" command.
export const DOCS_TEXT = [
  '📖 PANDUAN LENGKAP — Keuangan Saya',
  '',
  '━━ 1. Mencatat transaksi ━━',
  'Cukup tulis apa + nominal. Nominal bisa: 50rb, 50.000, 50k, 1,5jt, 2juta.',
  '• Pengeluaran: "makan siang 50rb", "bensin 25k", "belanja 100.000"',
  '• Pemasukan (otomatis dari kata kunci): "gaji 10jt", "bonus 500rb", "proyek 2jt"',
  '• Pakai rekening tertentu: "makan 50rb bca"',
  '• Kemarin: "kemarin kopi 20rb"',
  '',
  '━━ 2. Kategori ━━',
  '• "kategori" — lihat semua kategori kamu',
  '• "kategori tambah <nama>" — tambah kategori pengeluaran baru, mis. "kategori tambah Zakat"',
  '• "kategori tambah pemasukan <nama>" — tambah kategori pemasukan',
  'Setelah ditambah, langsung bisa dipakai: "zakat 100rb".',
  '',
  '━━ 3. Saldo & rekening ━━',
  '• "saldo" — saldo semua rekening + total',
  '• "transfer 500rb bca ke mandiri" — pindah kas antar rekening',
  '',
  '━━ 4. Budget bulanan ━━',
  '• "budget" — lihat budget vs pengeluaran bulan ini',
  '• "budget makan 2jt" — set budget kategori',
  '',
  '━━ 5. Utang & Piutang ━━',
  '• "utang Budi 200rb jatuh tempo 25/8" — kamu berutang',
  '• "piutang Sari 500rb" — orang berutang ke kamu',
  '',
  '━━ 6. Target menabung ━━',
  '• "target liburan 5jt tanggal 31/12"',
  '',
  '━━ 7. Lainnya ━━',
  '• "undo" — batalkan transaksi terakhir',
  '• "login" — buka dashboard (grafik, level kekayaan, skor kesehatan)',
  '• "stop" / "mulai" — matikan / nyalakan ringkasan mingguan',
